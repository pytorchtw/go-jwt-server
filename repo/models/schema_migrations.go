...
type SchemaMigration struct {
	Version int64 `v4.7.0:"version" boil:"version" json:"version" toml:"version" yaml:"version"`
	Dirty   bool  `v4.7.0:"dirty" boil:"dirty" json:"dirty" toml:"dirty" yaml:"dirty"`

	R *schemaMigrationR `v4.7.0:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L schemaMigrationL  `v4.7.0:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
